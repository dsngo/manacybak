  ...
  protected static setOptions(options: ng.IComponentOptions) {
    ...
    if( navigator.userAgent.match(/Android/i)
      ...
      || navigator.userAgent.match(/Windows Phone/i)
        ...
        options.templateUrl = "../components/appDrawingSettingMobile.html";
      }
      else {
        options.templateUrl = "../components/appDrawingSetting.html";
      }
}
...
private strokeItems: Array<any> = [ 1, 5, 10, 20, 50, 100, 200 ];

private scrollStrokeValue(): void{
  const staticStrokeItems: Array<any> = [ 1, 1, 5, 10, 20, 50, 100, 200 ];
...
private colorItems: Array<string> = [
"#000000",
"#FFFFFF",
"#E60012",
"#F39800",
...
private fontSizeItems: Array<number> =[10, 20, 30, 40, 50, 60, 70, 80];
...
private selectFontChange(){
  const staticfontSizeItems: Array<number> =[10, 20, 30, 40, 50, 60, 70, 80];
