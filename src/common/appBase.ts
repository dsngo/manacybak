...
import registerRecursive from "./recursive";
...
export default class AppBase {
    ...
    public static getModule(): ng.IModule {
        this.appModule =
            ...
            angular.module(this.getAppModuleName(),
                ["mdColorPicker", "ngMaterial", "ui.router", "ngSanitize", "restangular", "vAccordion", "ngAnimate",
                    "ngQuill", "ngFileUpload", "angular-carousel"]);
    ...
    protected static Init() {
        ...
        this.getModule().config(["$mdThemingProvider", ($mdThemingProvider) => {
        ...
        this.getModule().config(["$mdGestureProvider", ($mdGestureProvider) => {
		...
		registerRecursive(this.getModule());
    }
}
